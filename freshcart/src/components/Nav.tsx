    ...
    ? createPortal(
        <AnimatePresence>
          <motion.div
            ...
            className="fixed top-0 left-0 h-full w-[75%] sm:w-[60%] z-999 bg-linear-to-b from-green-800/90 to-green-900/90 backdrop-blur-xl border-r border-green-400/20 shadow-[0_0_50px_-10px_rgba(0,255,100,0.3)] flex flex-col p-6 text-white"
          >
            ...
            <div className="flex items-center gap-3 p-3 mt-3 rounded-xl bg-white/10 hover:bg-white/15 transition-all shadow-inner">
              <div className="relative w-12 h-12 flex items-center justify-center rounded-full overflow-hidden border-2 border-green-400/60 shadow-lg">
                {user.image ? (
                  <Image
                    src={user.image}
                    alt="user"
      ...
      <div className="flex items-center gap-3 md:gap-6 relative">
        ...
        {user.role == "admin" && (
          <>
            ...
            >
              <Menu className="tetx-green-600 w-6 h-6" />
            </div>
          </>
        )}
        <div className="relative">
          <div
            className="bg-white relative rounded-full w-11 h-11 flex items-center justify-center overflow-hidden shadow-md hover:scale-105 transition-transform"
