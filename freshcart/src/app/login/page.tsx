  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative">
      ...
      <p className="tetx-gray-600 mb-8 flex items-center justify-center gap-1">
        Login to Freshcart <Leaf className="w-5 h-5 text-green-600" />
      </p>
      <motion.form
      ...
      >
        ...
        <div
          className="w-full flex items-center justify-center gap-3 cursor-pointer border border-gray-300 hover:bg-gray-50 py-3 rounded-xl text-gray-700 font-medium transition-all duration-200"
